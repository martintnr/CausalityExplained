...
To process the coronary heart disease trait from CARDIoGRAMplusC4D using the Causality Explained framework, with phenome-wide UK Biobank data serving as predictors:
